{
    ...
    inputs = {
        ...
        split-monitor-workspaces = { url = "github:zjeffer/split-monitor-workspaces?rev=a450aba7f4e0ad231af5d47ac45efcfc42acefc0"; inputs.hyprland.follows = "hyprland"; };
