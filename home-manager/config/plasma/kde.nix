{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-9c1db74a-7d01-413e-8e1d-e0ae2f13c53c" = [ ];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to A user-defined custom Layout" = [ ];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (Carpalx, full optimization)" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."9c1db74a-7d01-413e-8e1d-e0ae2f13c53c" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "9c1db74a-7d01-413e-8e1d-e0ae2f13c53c";
      "kcminputrc"."Keyboard"."RepeatDelay" = 250;
      "kcminputrc"."Libinput/6940/7004/Corsair CORSAIR NIGHTSWORD RGB Gaming Mouse"."PointerAcceleration" = 1.000;
      "kcminputrc"."Libinput/6940/7004/Corsair CORSAIR NIGHTSWORD RGB Gaming Mouse"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Libinput/6940/7004/Corsair CORSAIR NIGHTSWORD RGB Gaming Mouse"."ScrollFactor" = 1;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1076,720";
      "kdeglobals"."General"."LastUsedCustomAccentColor" = "146,110,228";
      "kdeglobals"."General"."XftHintStyle" = "hintslight";
      "kdeglobals"."General"."XftSubPixel" = "rgb";
      "kdeglobals"."General"."fixed" = "JetBrains Mono Light,12,-1,5,25,0,0,0,0,0,Regular";
      "kdeglobals"."General"."font" = "JetBrains Mono,12,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "JetBrains Mono SemiBold,10,-1,5,63,0,0,0,0,0,Regular";
      "kdeglobals"."General"."smallestReadableFont" = "JetBrains Mono,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "JetBrains Mono SemiBold,12,-1,5,63,0,0,0,0,0,Regular";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 484;
      "kdeglobals"."KFileDialog Settings"."View Style" = "DetailTree";
      "kdeglobals"."KScreen"."ScaleFactor" = 2;
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "DP-0=2;DP-1=2;DP-2=2;DP-3=2;HDMI-0=2;DP-4=2;DP-5=2;";
      "kdeglobals"."PreviewSettings"."MaximumRemoteSize" = 0;
      "kdeglobals"."WM"."activeBackground" = "47,52,63";
      "kdeglobals"."WM"."activeBlend" = "47,52,63";
      "kdeglobals"."WM"."activeFont" = "JetBrains Mono SemiBold,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{a5d27507-f086-4fb7-8aa7-f05eb281c05f}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{3fef67f2-c533-4429-a134-d5e90d5be106}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{e8eb0ee1-58ca-4c85-8301-b0f1d6f08666}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{f86a29e8-b5d7-4ad0-8ece-6f5a02b22216}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{94ea4475-b1e3-4496-8e88-ac79fb810778}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{328af380-d5c2-4a60-8822-c603793be87b}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{89ff5a50-60d6-44c2-8f82-3536002ded2e}";
      ...
      "kwinrc"."Desktops"."Id_1" = "70eb98ef-fc07-40ef-b2df-bc0f24f3fd6c";
      "kwinrc"."Desktops"."Id_2" = "ca527aa8-26cd-4204-9e36-a723318f5424";
      "kwinrc"."Desktops"."Id_3" = "1a84c805-c687-4042-9d9d-9c642764db88";
      "kwinrc"."Desktops"."Id_4" = "4e7ef228-af74-40a6-8a80-591dfc030864";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-cube"."BorderActivate" = "1,7";
      "kwinrc"."Effect-diminactive"."DimFullScreen" = false;
      "kwinrc"."Effect-diminactive"."Strength" = 10;
      "kwinrc"."Effect-kwin4_effect_tv_glitch"."Color" = "invalid";
      "kwinrc"."Effect-kwin4_effect_tv_glitch"."Duration" = 350;
      "kwinrc"."Effect-kwin4_effect_tv_glitch"."Scale" = 5;
      "kwinrc"."Effect-kwin4_effect_tv_glitch"."Strength" = 3;
      "kwinrc"."Effect-mouseclick"."ShowText" = false;
      "kwinrc"."Effect-overview"."BorderActivate" = 9;
      "kwinrc"."ElectricBorders"."BottomLeft" = "ShowDesktop";
      "kwinrc"."ElectricBorders"."BottomRight" = "ShowDesktop";
      "kwinrc"."MouseBindings"."CommandAll2" = "Raise";
      "kwinrc"."MouseBindings"."CommandAllWheel" = "Change Opacity";
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 45.55;
      "kwinrc"."NightColor"."LongitudeAuto" = "-122.5";
      "kwinrc"."NightColor"."NightTemperature" = 3500;
      "kwinrc"."Plugins"."alwaysopenonprimaryscreenEnabled" = false;
      ...
      "kwinrc"."TabBoxAlternative"."MinimizedMode" = 1;
      "kwinrc"."TabBoxAlternative"."MultiScreenMode" = 1;
      "kwinrc"."TabBoxAlternative"."OrderMinimizedMode" = 1;
      "kwinrc"."TabBoxAlternative"."ShowDesktopMode" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/10f88b58-c22e-576f-a799-efdf7a2f50ea"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/37f8f1ce-4f7b-588b-aecb-e9de09e87298"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/58c52117-18c6-5468-a60c-6fc49d825bcb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/5985974c-dbab-5eee-b2b3-38dfae78056b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/7d0c20b7-22a3-594e-b218-8c2ac442128a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/816822de-68fe-5160-b846-9e7d6927abca"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ade22b4b-d73d-5c68-8549-008520c9fc9b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/c43094a0-437b-5075-93a1-f0fcf0b68993"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/fb86e0d8-90d3-590b-8a16-f2bff92935b6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Wayland"."EnablePrimarySelection" = false;
      "kwinrc"."Windows"."AutoRaise" = true;
      "kwinrc"."Windows"."AutoRaiseInterval" = 500;
      "kwinrc"."Windows"."CenterSnapZone" = 15;
      "kwinrc"."Windows"."DelayFocusInterval" = 0;
      "kwinrc"."Windows"."ElectricBorderDelay" = 100;
      ...
      "kwinrc"."org.kde.kdecoration2"."ButtonsOnLeft" = "MH";
      "kwinrc"."org.kde.kdecoration2"."ButtonsOnRight" = "LIAX";
      "kxkbrc"."Layout"."DisplayNames" = ",cus";
      "kxkbrc"."Layout"."LayoutList" = "us,custom";
      "kxkbrc"."Layout"."Model" = "pc105";
      "kxkbrc"."Layout"."Options" = "grp:alts_toggle,grp_led:scroll";
      "kxkbrc"."Layout"."ResetOldOptions" = true;
      "kxkbrc"."Layout"."Use" = true;
      "kxkbrc"."Layout"."VariantList" = ",";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT" = "en_CA.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME" = "en_AI.UTF-8";
